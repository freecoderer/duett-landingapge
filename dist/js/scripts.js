...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Toggle terms and conditions text
    ...
    const submitButtonFooter = document.getElementById('submitButtonFooter');
    ...
    if (emailAddressInput) emailAddressInput.addEventListener('input', validateForm);
    if (termsCheckboxFooter) termsCheckboxFooter.addEventListener('change', validateFormFooter);
    if (emailAddressInputFooter) emailAddressInputFooter.addEventListener('input', validateFormFooter);
